...
configuration were within reach.  Unfortunately, it's stored in multiple remote
repositories and processed remotely in ArgoCD.   ArgoCD is like a black box.
Intermediate state is inaccessible.  The final configuration is only accessible
after it's been applied, far too late to consider what impact a change might
have.
