...
This guide strives to keep things neat and tidy.  All of the resources it
creates on your machine are located in k3d or in the `holos-k3d` directory.
...
Expect to see a large whole number like `215559239589843464`.  Copy and paste
this value into the Subject field of the Role Based Access Control section and
then submit the form.

### GitOps {#GitOps}

For the ArgoCD Git repository URL form field, enter the url of your Github fork
where you pushed your local `holos-k3d` repository and then submit the form.
