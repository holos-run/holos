...
Visit [https://httpbin.holos.localhost/](https://httpbin.holos.localhost/) in your browser at this point to verify everything is working.

:::

The browser should not report any security warnings and you should get the httpbin welcome page.
