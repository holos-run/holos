...
Start by creating a directory for `podinfo`, touching an empty CUE file,
...
| File | Purpose
| - | - |
`projects/tutorial/components/podinfo/podinfo.cue` | Identifies and configures the `podinfo` Helm chart.
...
directory contains the `#Platform` definition and the data Holos needs to kick
off the rendering process:
...
The `projects/tutorial/components/podinfo/podinfo.cue` file unifies the `#Helm`
...
out the [Helm Generator tutorial][nexthelm] to learn more.

[podinfo]: https://github.com/stefanprodan/podinfo
[nexthelm]: ./helm-generator.mdx
