...
implemented by asserting against your oidc id token subject claim.  Update the
form with the `sub` claim value from your id token.  This will ensure only you
have access to platform services.
