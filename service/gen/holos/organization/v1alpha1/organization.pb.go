...
var file_holos_organization_v1alpha1_organization_proto_goTypes = []any{
...
func file_holos_organization_v1alpha1_organization_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_holos_organization_v1alpha1_organization_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_holos_organization_v1alpha1_organization_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
