...
var file_holos_platform_v1alpha1_platform_proto_goTypes = []any{
...
func file_holos_platform_v1alpha1_platform_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_holos_platform_v1alpha1_platform_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_holos_platform_v1alpha1_platform_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Owner); i {
			case 0:
				return &v.state
			case 1:
		...
		file_holos_platform_v1alpha1_platform_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Spec); i {
			case 0:
				return &v.state
			case 1:
	...
	file_holos_platform_v1alpha1_platform_proto_msgTypes[0].OneofWrappers = []any{}
	file_holos_platform_v1alpha1_platform_proto_msgTypes[1].OneofWrappers = []any{
		(*Owner_OrgId)(nil),
	}
	file_holos_platform_v1alpha1_platform_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
