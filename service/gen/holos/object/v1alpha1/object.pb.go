...
var file_holos_object_v1alpha1_object_proto_goTypes = []any{
...
func file_holos_object_v1alpha1_object_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_holos_object_v1alpha1_object_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Detail); i {
			case 0:
				return &v.state
			case 1:
		...
		file_holos_object_v1alpha1_object_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_holos_object_v1alpha1_object_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_holos_object_v1alpha1_object_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_holos_object_v1alpha1_object_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_holos_object_v1alpha1_object_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_holos_object_v1alpha1_object_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Form); i {
			case 0:
				return &v.state
			case 1:
		...
		file_holos_object_v1alpha1_object_proto_msgTypes[7].Exporter = func(v any, i int) any {
	...
	file_holos_object_v1alpha1_object_proto_msgTypes[0].OneofWrappers = []any{}
	file_holos_object_v1alpha1_object_proto_msgTypes[2].OneofWrappers = []any{
		(*UserRef_UserId)(nil),
		(*UserRef_Email)(nil),
		(*UserRef_Subject)(nil),
	}
	file_holos_object_v1alpha1_object_proto_msgTypes[3].OneofWrappers = []any{
		(*OrganizationRef_OrgId)(nil),
		(*OrganizationRef_OrgName)(nil),
	}
	file_holos_object_v1alpha1_object_proto_msgTypes[4].OneofWrappers = []any{
		(*ResourceEditor_UserId)(nil),
	}
	file_holos_object_v1alpha1_object_proto_msgTypes[5].OneofWrappers = []any{
