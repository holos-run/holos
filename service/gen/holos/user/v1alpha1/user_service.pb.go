...
var file_holos_user_v1alpha1_user_service_proto_goTypes = []any{
...
func file_holos_user_v1alpha1_user_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_holos_user_v1alpha1_user_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_holos_user_v1alpha1_user_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_holos_user_v1alpha1_user_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_holos_user_v1alpha1_user_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_holos_user_v1alpha1_user_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_holos_user_v1alpha1_user_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	file_holos_user_v1alpha1_user_service_proto_msgTypes[0].OneofWrappers = []any{}
	file_holos_user_v1alpha1_user_service_proto_msgTypes[2].OneofWrappers = []any{}
	file_holos_user_v1alpha1_user_service_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
