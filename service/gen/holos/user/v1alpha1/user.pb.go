...
var file_holos_user_v1alpha1_user_proto_goTypes = []any{
...
func file_holos_user_v1alpha1_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_holos_user_v1alpha1_user_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
	...
	file_holos_user_v1alpha1_user_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
