...
// Helm assembles a TaskSet rendering a helm chart.  Useful to mix in
...
// Kubernetes assembles a TaskSet containing inline resources exported from
// CUE.
...
// Kustomize assembles a TaskSet rendering manifests from a [kustomize]
// kustomization.
//
// [kustomize]: https://kubectl.docs.kubernetes.io/references/kustomize/kustomization/
